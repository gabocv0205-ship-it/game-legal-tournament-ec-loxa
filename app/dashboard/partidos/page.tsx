...
export default function PartidosPage() {
  ...
  const imprimirPlanilla = async (partido: any, esEstandar = false) => {
    ...
    const html = `<!DOCTYPE html><html lang="es"><head><title>Planilla oficial</title><style>
      @page{size:A4 portrait;margin:6mm}*{box-sizing:border-box}html,body{width:210mm;height:297mm;margin:0}body{font-family:Arial,Helvetica,sans-serif;color:#111827;background:#fff}.sheet{width:198mm;height:285mm;padding:4mm;border:2px solid #111827;display:flex;flex-direction:column;gap:1.7mm;overflow:hidden;position:relative}.sheet:before{content:"";position:absolute;left:4mm;right:4mm;top:50%;border-top:1px dashed #94a3b8;z-index:1}
      ...
      .teams{display:grid;grid-template-columns:1fr;grid-template-rows:1fr 1fr;gap:3.5mm;flex:1;min-height:0}.team-half{min-height:0;display:flex;flex-direction:column;page-break-inside:avoid;break-inside:avoid;border:1px solid #cbd5e1;padding:1.5mm}.cut-line{display:none}.half-brand{display:flex;justify-content:space-between;align-items:center;border-bottom:2px solid #0f5132;margin-bottom:.7mm}.half-brand strong{font-size:8px;text-transform:uppercase;letter-spacing:.5px}.half-brand span{font-size:6px;color:#0f5132;font-weight:900}.team-head{display:grid;grid-template-columns:1fr auto;align-items:center;background:#111827;color:#fff;border:1px solid #111827}.team-head span{display:block;padding:2px 5px 0;font-size:6px;text-transform:uppercase;color:#d1fae5}.team-head h2{font-size:9px;text-transform:uppercase;padding:0 5px 2px;margin:0}.team-meta{font-size:6px;font-weight:900;text-transform:uppercase;padding:4px;text-align:right;color:#d1fae5}
