...
export default function PartidosPage() {
  ...
  const imprimirPlanilla = async (partido: any, esEstandar = false) => {
    ...
    const html = `<!DOCTYPE html><html lang="es"><head><title>Planilla oficial</title><style>
      ...
      .teams{display:flex;flex:1;flex-direction:column;gap:0}.team-half{min-height:111mm;display:flex;flex-direction:column;page-break-inside:avoid;break-inside:avoid}.cut-line{position:relative;margin:2mm 0;border-top:1px dashed #6b7280;text-align:center;color:#6b7280;font-size:7px;font-weight:900;text-transform:uppercase}.cut-line span{position:relative;top:-6px;background:#fff;padding:0 8px}.team-head{display:grid;grid-template-columns:1fr auto;align-items:center;background:#111827;color:#fff;border:1px solid #111827}.team-head span{display:block;padding:4px 6px 0;font-size:7px;text-transform:uppercase;color:#d1fae5}.team-head h2{font-size:12px;text-transform:uppercase;padding:0 6px 4px;margin:0}.team-meta{font-size:8px;font-weight:900;text-transform:uppercase;padding:6px;text-align:right;color:#d1fae5}table{border-collapse:collapse;width:100%;table-layout:fixed;font-size:7px;page-break-inside:avoid;break-inside:avoid}col.player-id{width:14%}col.shirt{width:6%}col.player-name{width:28%}col.role{width:6%}col.goals{width:6%}col.yellow{width:5%}col.red{width:5%}col.substitution{width:13%}col.entered-for{width:17%}th,td{border:1px solid #9ca3af;padding:2px;height:7.4mm;overflow:hidden}th{height:6mm;background:#f1f5f9;text-transform:uppercase;line-height:1.1}.suspended{border:1px solid #f1b0a7;border-left:3px solid #b42318;background:#fff5f5;padding:4px;font-size:7px;margin-top:3px;min-height:12mm;page-break-inside:avoid;break-inside:avoid}.team-footer{display:grid;grid-template-columns:1fr 1fr 1fr;gap:4px;font-size:7px;margin-top:auto;padding-top:3px}.team-footer div{border:1px solid #9ca3af;min-height:9mm;padding:3px}.observations{display:none}
      .review-grid{display:grid;grid-template-columns:1fr 1fr;gap:5px}.ruled-box{border:1px solid #111827;padding:5px;min-height:22mm;font-size:8px}.ruled-box strong{display:block;text-transform:uppercase;margin-bottom:3px}.auto-list{margin:0 0 3px 0;padding-left:12px}.auto-list li{margin-bottom:1px}.manual-note{border:1px dashed #9ca3af;background:#f8fafc;padding:3px;margin-bottom:3px}.lines span{display:block;height:7px;border-bottom:1px solid #cbd5e1}.pending{border:1px solid #0f5132;background:#f7fbf9;padding:5px;font-size:8px}.pending strong{display:block;text-transform:uppercase;margin-bottom:3px;color:#0f5132}.signatures{display:grid;grid-template-columns:repeat(4,1fr);gap:8mm;padding-top:8px;page-break-inside:avoid;break-inside:avoid}.signatures div{border-top:1px solid #111827;text-align:center;padding-top:3px;font-size:7px;text-transform:uppercase;font-weight:700}
