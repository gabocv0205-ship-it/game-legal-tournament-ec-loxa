  ...
  return (
    <main className="guest-portal">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .guest-hero { width:min(1180px,calc(100% - 32px)); margin:0 auto; padding:clamp(50px,9vw,112px) 0 clamp(56px,8vw,96px); display:grid; grid-template-columns:minmax(0,1.15fr) minmax(300px,.75fr); gap:42px; align-items:center; }
        ...
        @media (max-width:780px) { .guest-nav { padding:16px 0; }.guest-nav-link:not(.primary) { display:none; }.guest-hero { grid-template-columns:1fr; padding-top:56px; }.guest-live-card { max-width:520px; }.guest-section-head { align-items:start; flex-direction:column; }.guest-section-note { max-width:600px; }.guest-footer { align-items:flex-start; flex-direction:column; }.guest-title { font-size:clamp(45px,15vw,72px); } }
