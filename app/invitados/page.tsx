  ...
  return (
    <main className="guest-portal">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (prefers-reduced-motion:reduce) { .guest-ticker span { animation:none; padding-left:16px; }.guest-live-card,.guest-live-card:hover { transform:none; transition:none; } }
      ` }} />
      ...
      <section className="guest-hero">
        <div>
          ...
          <div className="guest-proof-pills"><span className="guest-proof-pill"><i className="fa fa-bolt" />Datos al instante</span><span className="guest-proof-pill"><i className="fa fa-shield-halved" />Resultados oficiales</span><span className="guest-proof-pill"><i className="fa fa-share-nodes" />Listo para compartir</span></div>
        </div>
